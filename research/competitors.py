...
SYSTEM_PROMPT = (
    ...
    "  - pricing_tier: normalized pricing tier ('budget', 'mid-market', 'premium', or 'enterprise')\n"
    ...
    "  - services: normalized list of 3-5 services they visibly offer\n"
    ...
    "  - content_quality: short note on visible site content quality\n"
    "  - seo_notes: short note on visible SEO/content footprint\n"
